...
curl --output julia.tgz "https://julialang-s3.julialang.org/bin/linux/${JULIA_SHORT_ARCH}/${JULIA_MAJOR_MINOR}/${JULIA_INSTALLER}"
tar xzf julia.tgz -C "/opt/julia-${JULIA_VERSION}" --strip-components=1
rm julia.tgz
