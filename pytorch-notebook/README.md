![docker pulls](https://img.shields.io/docker/pulls/jupyter/pytorch-notebook.svg) ![docker stars](https://img.shields.io/docker/stars/jupyter/pytorch-notebook.svg) [![](https://images.microbadger.com/badges/image/jupyter/pytorch-notebook.svg)](https://microbadger.com/images/jupyter/pytorch-notebook "jupyter/pytorch-notebook image metadata")

# Jupyter Notebook Scientific Python Stack + PyTorch

## What it Gives You

* Everything in [Scipy Notebook](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook)
* PyTorch for Python 3.x (without GPU support)
...
```
docker run -it --rm -p 8888:8888 jupyter/pytorch-notebook
```
...
```
docker run -d -p 8888:8888 jupyter/pytorch-notebook start-notebook.sh --NotebookApp.password='sha1:74ba40f8a388:c913541b7ee99d15d5ed31d4226bf7838f83a50e'
```

For example, to set the base URL of the notebook server, run the following:

```
docker run -d -p 8888:8888 jupyter/pytorch-notebook start-notebook.sh --NotebookApp.base_url=/some/path
```

For example, to disable all authentication mechanisms (not a recommended practice):

```
docker run -d -p 8888:8888 jupyter/pytorch-notebook start-notebook.sh --NotebookApp.token=''
```
...
docker run -d -p 8888:8888 \
    ...
    jupyter/pytorch-notebook start-notebook.sh \
...
```
docker run -it --rm jupyter/pytorch-notebook start.sh ipython
```

Or, to run JupyterLab instead of the classic notebook, run the following:

```
docker run -it --rm -p 8888:8888 jupyter/pytorch-notebook start.sh jupyter lab
```
