...
1. By default, the `.github/workflows/docker.yaml` file generated by the cookiecutter template will trigger the CI pipeline whenever you push to your `main` branch
