...
| [myLab TH Lübeck JupyterHub Images][gpu_thl] | Collection of images based on the **jupyter/docker-stacks**, built and maintained at the [myLab TH Lübeck](https://mylab.th-luebeck.de) using build scripts similar to iot-salzburg. Also includes several images with gpu libraries                                                                                           |
