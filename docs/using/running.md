...
This command pulls the `jupyter/scipy-notebook` image tagged `2023-05-25` from Docker Hub if it is not already present on the local host.
...
```bash
docker run -it -p 8888:8888 jupyter/scipy-notebook:2023-05-25
...
# 221331c047c4   jupyter/scipy-notebook:2023-05-25                   "tini -g -- start-no…"   11 seconds ago   Exited (0) 8 seconds ago             cranky_benz
...
This command pulls the `jupyter/r-notebook` image tagged `2023-05-25` from Docker Hub if it is not already present on the local host.
...
```bash
docker run -it --rm -p 10000:8888 -v "${PWD}":/home/jovyan/work jupyter/r-notebook:2023-05-25
```
...
This command pulls the `docker.io/jupyter/r-notebook` image tagged `2023-05-25` from Docker Hub if it is not already present on the local host.
...
podman run -it --rm -p 10000:8888 \
    ...
    docker.io/jupyter/r-notebook:2023-05-25
```
