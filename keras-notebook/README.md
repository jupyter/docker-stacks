![docker pulls](https://img.shields.io/docker/pulls/jupyter/keras-notebook.svg) ![docker stars](https://img.shields.io/docker/stars/jupyter/keras-notebook.svg) [![](https://images.microbadger.com/badges/image/jupyter/keras-notebook.svg)](https://microbadger.com/images/jupyter/keras-notebook "jupyter/keras-notebook image metadata")

# Jupyter Notebook Scientific Python Stack + Tensorflow + Keras

## What it Gives You

* Everything in [Tensorflow Notebook](https://github.com/jupyter/docker-stacks/tree/master/tensorflow-notebook)
* Tensorflow for Python 2.7 and 3.5 (without GPU support)
* Keras with Tensorflow support
...
```
docker run -it --rm -p 8888:8888 jupyter/keras-notebook
```
