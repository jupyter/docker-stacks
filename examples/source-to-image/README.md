...
The base image which the files will be combined with is `quay.io/jupyter/minimal-notebook:latest`, but you can specify any of the Jupyter Project `docker-stacks` images as the base image.
...
oc new-app --template jupyter-notebook-quickstart \
    ...
    --param BUILDER_IMAGE=quay.io/jupyter/minimal-notebook:latest \
